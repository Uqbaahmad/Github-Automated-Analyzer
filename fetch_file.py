...
#     score = 0.0
#     response = requests.get(f'https://api.github.com/repos/{user}/{repository_name}/contents')
...
#             if item['type'] == 'file':
#                 file_path = item['path']
#                 file_response = requests.get(f'https://raw.githubusercontent.com/{user}/{repository_name}/master/{file_path}')
